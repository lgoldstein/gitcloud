 ...
 * @author Lyor G.
 * @since Jun 25, 2013 9:45:53 AM
 */
public abstract class AbstractExtendedValue2IntTransfomer<V> implements ExtendedValue2IntTransfomer<V> {
    private final Class<V>  valueType;
    
    protected AbstractExtendedValue2IntTransfomer(Class<V> argType) {
