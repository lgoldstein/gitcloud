 ...
 * @author Lyor G.
 */
public class StringToPeriodConverter extends AbstractExtendedConverter<String,Period> {
    public static final StringToPeriodConverter INSTANCE=new StringToPeriodConverter();
