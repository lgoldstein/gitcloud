 ...
 */
package net.community.chest.gitcloud.facade.frontend;
 ...
 * @since Sep 12, 2013 1:07:22 PM
 */
public class FacadeEnvironmentInitializer extends AbstractEnvironmentInitializer {
    public static final String  PROPS_FILE_NAME="gitcloud-frontend.properties";
                ...
                Collections.singletonList(
                        Pair.<String,Collection<String>>of("META-INF/" + ConfigUtils.CONF_DIR_NAME,
                                Collections.unmodifiableList(
                                        Arrays.asList(PROPS_FILE_NAME, "gitcloud-frontend-log4j.xml")))));
    }
}
